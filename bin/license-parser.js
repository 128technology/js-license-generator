...
if (argv.help) {
  ...
  console.log('Takes in a license text document and generates a json version of it.');
  console.log('The license text should be formatted like the ones that js-license-generator makes');
  console.log();
  ...
  console.log('--ignore=<name1, name2>        Comma separated files to ignore (when licenseDirectory supplied).');
...
fs.writeFileSync(`${outputName}.json`, JSON.stringify(licenses.getLicenses()), 'utf-8');
